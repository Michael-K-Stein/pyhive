...
T = TypeVar("T", bound="PatchedEventKioskRequest")


@_attrs_define
class PatchedEventKioskRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_event_kiosk_request = cls(
            start=start,
            end=end,
            type_=type_,
            location=location,
        ...
        patched_event_kiosk_request.additional_properties = d
        return patched_event_kiosk_request
