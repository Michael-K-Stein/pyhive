...
T = TypeVar("T", bound="PaginatedHelpList")


@_attrs_define
class PaginatedHelpList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Help.from_dict(results_item_data)
        ...
        paginated_help_list.additional_properties = d
        return paginated_help_list
