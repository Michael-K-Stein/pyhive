...
T = TypeVar("T", bound="AssignmentResponseRequest")


@_attrs_define
class AssignmentResponseRequest:
    """
    Attributes:
        contents (list['AssignmentResponseContentRequest']):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        for contents_item_element in self.contents:
            files.append(("contents", (None, json.dumps(contents_item_element.to_dict()).encode(), "application/json")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignment_response_request = cls(
            contents=contents,
            response_type=response_type,
            file_name=file_name,
            file=file,
        ...
        assignment_response_request.additional_properties = d
        return assignment_response_request
