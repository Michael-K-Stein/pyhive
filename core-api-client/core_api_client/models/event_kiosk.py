...
if TYPE_CHECKING:
    from ..models.event_kiosk_attendees_type_0_item import EventKioskAttendeesType0Item


T = TypeVar("T", bound="EventKiosk")
...
class EventKiosk:
    ...
    Attributes:
        ...
        attendees (Union[None, list['EventKioskAttendeesType0Item']]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attendees(data: object) -> Union[None, list["EventKioskAttendeesType0Item"]]:
            if data is None:
                return data
            try:
                ...
                for attendees_type_0_item_data in _attendees_type_0:
                    attendees_type_0_item = EventKioskAttendeesType0Item.from_dict(attendees_type_0_item_data)
                ...
                pass
            return cast(Union[None, list["EventKioskAttendeesType0Item"]], data)
        ...
        event_kiosk.additional_properties = d
        return event_kiosk
