...
T = TypeVar("T", bound="PatchedHelpResponseRequest")


@_attrs_define
class PatchedHelpResponseRequest:
    """
    Attributes:
        ...
        response_type (Union[Unset, HelpResponseTypeEnum]): * `Resolve` - Resolve
            * `Open` - Open
            * `Comment` - Comment
    """
    ...
    response_type: Union[Unset, HelpResponseTypeEnum] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_type: Union[Unset, HelpResponseTypeEnum]
        if isinstance(_response_type, Unset):
            response_type = UNSET
        else:
            response_type = HelpResponseTypeEnum(_response_type)

        patched_help_response_request = cls(
            contents=contents,
            file_name=file_name,
            file=file,
        ...
        patched_help_response_request.additional_properties = d
        return patched_help_response_request
