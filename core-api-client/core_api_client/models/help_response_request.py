...
T = TypeVar("T", bound="HelpResponseRequest")


@_attrs_define
class HelpResponseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        help_response_request.additional_properties = d
        return help_response_request
