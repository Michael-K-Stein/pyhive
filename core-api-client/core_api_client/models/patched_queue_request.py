...
T = TypeVar("T", bound="PatchedQueueRequest")


@_attrs_define
class PatchedQueueRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_queue_request.additional_properties = d
        return patched_queue_request
