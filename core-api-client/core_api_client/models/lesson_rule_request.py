...
T = TypeVar("T", bound="LessonRuleRequest")


@_attrs_define
class LessonRuleRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lesson_rule_request = cls(
            parent_rule=parent_rule,
            student_groups=student_groups,
            queue=queue,
        )

        lesson_rule_request.additional_properties = d
        return lesson_rule_request
