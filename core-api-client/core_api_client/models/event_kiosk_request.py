...
T = TypeVar("T", bound="EventKioskRequest")


@_attrs_define
class EventKioskRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_kiosk_request.additional_properties = d
        return event_kiosk_request
