...
T = TypeVar("T", bound="HelpResponseSegelNestedRequest")


@_attrs_define
class HelpResponseSegelNestedRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        help_response_segel_nested_request = cls(
            response_type=response_type,
            contents=contents,
            file_name=file_name,
            file=file,
        ...
        help_response_segel_nested_request.additional_properties = d
        return help_response_segel_nested_request
